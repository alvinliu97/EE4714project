		...
		<form method="post" id="form--login">
			...
			<div class="u-flex">
				...
				<div class="login__action--secondary">
					...
					<span id="login--switch">New to VAPORS? <span id="login--switch" class="button--text">Create free account</span></span>
				</div>
			</div>
		</form>
	</div>
...
var HTML_REGISTER = `
    ...
    `</select>
							...
							<tr class="checkout__row">
								...
								<td>
									<span class="input">
										<input type="text" name="birthday" id="birthday" class="input--date u-fill">
									</span>
								</td>
							</tr>
						</tbody>
...
var validateEmail = function() {
    ...
    if (regExp2.test(name2) == false) {
        ...
        hideErrorWithMessage(document.getElementById("email"));
    }
}
